...
```bash
# 公网版
docker build -f public/Dockerfile.base -t your-registry/miniprogram-ci-base:1.2.0 .

# 内网版
docker build -f private/Dockerfile.base -t artifacts.iflytek.com/cbg-docker-private/xfyun_webdev/miniprogram-ci-base:1.2.0 .
```
